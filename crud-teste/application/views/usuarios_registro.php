                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-5">
                        ...
                        <div class="panel-body">
                            ...
                            ?>  
                                ...
                                <input class="form-control input-lg" type="text" id="Nome" name="Nome" value=""  required="required"  placeholder="Informe o nome do usuário" data-parsley-required="true"  /> 
                                
                                <BR/>                           
                                <BR/>
                                <label class="control-label col-md-4 col-sm-4">Nome da M&atilde;e:</label>	
                                <input class="form-control input-lg" type="text" id="Nome_mae" name="Nome_mae" value="" required="required" placeholder="Informe o nome da mãe" data-parsley-required="true"  /> 

                                <BR/>                           
                                <BR/>

                                 <label class="control-label col-md-4 col-sm-4">Nome do Pai:</label> 
                                <input class="form-control input-lg" type="text" id="Nome_pai" name="Nome_pai" value="" required="required" placeholder="Informe o nome do pai" data-parsley-required="true"  /> 

                                <BR/>                           
                                <BR/>
                                
                                <label class="control-label col-md-4 col-sm-4">E-mail:</label>	
                                <input class="form-control input-lg" id="Email" name="Email" type="email" required="required" class="input-text" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" value="" placeholder="Informe o e-mail do usuário" data-parsley-required="true"  /> 

                                <BR/>                           
                                <BR/>
                                
                                <label class="control-label col-md-4 col-sm-4">Data:</label>	
                                <input class="form-control form-control2 input-lg" type="text"" id="Data" name="Data" value="" required="required"  data-parsley-required="true"  /> 
